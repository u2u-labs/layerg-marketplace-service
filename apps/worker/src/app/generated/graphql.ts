...
export function getSdk(
  ...
  return {
    ...
    GetOrdersTransfer(
      variables: GetOrdersTransferQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
    ): Promise<GetOrdersTransferQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetOrdersTransferQuery>(
            GetOrdersTransferDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        'GetOrdersTransfer',
    ...
    userBalance1155(
      variables: UserBalance1155QueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
    ): Promise<UserBalance1155Query> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<UserBalance1155Query>(
            UserBalance1155Document,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        'userBalance1155',
    ...
    getStakingToAddWhiteList(
      variables: GetStakingToAddWhiteListQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
    ): Promise<GetStakingToAddWhiteListQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetStakingToAddWhiteListQuery>(
            GetStakingToAddWhiteListDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        'getStakingToAddWhiteList',
...
export type GetOrdersTransferQuery = {
  __typename?: 'Query';
  orderTransfers: Array<{
    __typename?: 'OrderTransfer';
    tokenId: string;
    timestamp: any;
    takeQty: any;
...
export type UserBalance1155Query = {
  __typename?: 'Query';
  erc1155Balance?: {
    __typename?: 'ERC1155Balance';
    valueExact: any;
...
export type GetStakingToAddWhiteListQuery = {
  __typename?: 'Query';
  delegators: Array<{
    __typename?: 'Delegator';
    totalLockStake: any;
