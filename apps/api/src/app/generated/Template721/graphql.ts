...
export const GetBalances721Document = gql`
  ...
  items(where: {tokenID: $tokenId}) {
    ...
    `;
export const GetOwner721Document = gql`
    query getOwner721($tokenId: BigInt!, $address: String!) {
  items(where: {and: [{tokenID: $tokenId}, {owner: $address}]}) {
    id
    owner {
      id
    }
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ...
    getOwner721(variables: GetOwner721QueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetOwner721Query> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetOwner721Query>(GetOwner721Document, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'getOwner721', 'query', variables);
    }
  };
}
...
export type GetOwner721QueryVariables = Exact<{
  tokenId: Scalars['BigInt']['input'];
  address: Scalars['String']['input'];
}>;


export type GetOwner721Query = { __typename?: 'Query', items: Array<{ __typename?: 'Item', id: string, owner: { __typename?: 'User', id: string } }> };
